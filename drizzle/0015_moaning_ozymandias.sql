ALTER TABLE "credit_operations" DROP CONSTRAINT IF EXISTS "credit_operations_credit_bounds_check";--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_user_id_id_unique" UNIQUE ("user_id","id");--> statement-breakpoint
ALTER TABLE "credit_operations" ADD CONSTRAINT "credit_operations_user_id_id_unique" UNIQUE ("user_id","id");--> statement-breakpoint
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_user_id_id_unique" UNIQUE ("user_id","id");--> statement-breakpoint
...
CREATE OR REPLACE FUNCTION prevent_credit_ledger_mutation() RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
	RAISE EXCEPTION 'credit ledger entries are append-only';
END;
$$;
--> statement-breakpoint
DROP TRIGGER IF EXISTS credit_ledger_entries_append_only ON "credit_ledger_entries";--> statement-breakpoint
